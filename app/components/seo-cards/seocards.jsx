...
function SeoCards(){
    ...
    return(
        ...
        <div className="seoCards">
            <Card
            title="¿Estás buscando un jardinero barato y rápido en Valencia?"
            ...
            <Card
            title="Damos un servicio de Poda y Tala Profesional en La Eliana"
            ...
            <Card
            title="¿Necesitas un jardinero particular que cuide de tu jardín?"
